...
public class EarthquakeAdapter extends ArrayAdapter<Earthquake> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        TextView txtMag = listItemView.findViewById(R.id.magnitude);
        ...
        TextView txtLocOff = listItemView.findViewById(R.id.location_offset);
        txtLocOff.setText(locationOffset);
        TextView txtLoc = listItemView.findViewById(R.id.primary_location);
        txtLoc.setText(primaryLocation);

        Date date = new Date(current.getDate());

        TextView txtDate = listItemView.findViewById(R.id.date);
        txtDate.setText(formatDate(date));

        TextView txtTime = listItemView.findViewById(R.id.time);
